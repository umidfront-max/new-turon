...
export default {
  ...
  detail: {
    ...
    doc: {
      ...
      openNew: 'Yangi oynada ochish',
      missing: 'Qaror hujjati biriktirilmagan',
  ...
  form: {
    ...
    requisite: {
      ...
      blocked: 'Diqqat: bu raqam allaqachon bloklangan',
      earlier: "Diqqat: bu raqam bo'yicha ilgari {n} ta ariza bor",
      checkOffline: "Server javob bermadi — tekshiruvsiz davom etyapsiz",
      attach: 'Briktirish',
      add: "Qo'shish",
